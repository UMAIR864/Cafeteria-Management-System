    ...
    public partial class formPOS : Form
    {
        ...
        private void AddItems(string id,String proID, string name, string cat, string price, Image pimage)
        {
            ...
            w.onSelect += (ss, ee) =>
            {
                ...
                {
                    //Check if product exist then a one to quantity and update price
                ...
                //Add new product 1st for sr# and 2nd 0 for ID
        ...
        private void BtnDelivery_Click(object sender, EventArgs e)
        {
            ...
            if (frm.txtName.Text != "")
            {
                raiderID = frm.raiderID;
                lblRaiderName.Text = "Customer Name: " + frm.txtName.Text + "   Phone: " + frm.txtPhone.Text + "   Address: "
                    + frm.txtAddress.Text + "   Rider: " + frm.cbRaider.Text;
                    ;
                lblRaiderName.Visible = true;
        ...
        private void btnTake_Click(object sender, EventArgs e)
        {
            ...
            {
                raiderID = frm.raiderID;
                lblRaiderName.Text = "Customer Name: " + frm.txtName.Text + "   Phone: " + frm.txtPhone.Text ;
                lblRaiderName.Visible = true;
                customerName = frm.txtName.Text;
                customerPhone = frm.txtPhone.Text;
            }
        ...
        private void btnKot_Click(object sender, EventArgs e)
        {
            ...
            { 
                qry1 = @"Insert into tblMain Values(@aDate , @aTime , @TableName , @WaiterName ,
                            @status , @orderType, @total , @received , @change, @raiderID, @CustName, @CustPhone, @CustAddress);
            ...
            int rowCount = GetDataRowCount(guna2DataGridView1);
            int GetDataRowCount(DataGridView dataGridView)
            {
                int rc = 0;
                ...
                foreach (DataGridViewRow row in dataGridView.Rows)
                {
                    if(rc>=1)
                    { break; }
                    // Check if the row is not a header row or any other special row
            ...
            if (rowCount < 1)
            {
                guna2MessageDialog1.Show("Please Select Product First.");
                return;
            }
            else
            {
                ...
                cmd.Parameters.AddWithValue("@raiderID", raiderID);
